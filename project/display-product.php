					...
					<div class="panel-body widget-shadow">
						...
						<table class="table">
							...
							<tbody>
								...
								if (isset($_GET['did'])) {
									$did = $_GET['did'];
									$delete = mysqli_query($connection, "delete from tbl_product where pro_id ='{$did}'") or
								...
								$select = mysqli_query($connection, "select * from tbl_product") or die(mysqli_error($connection));
